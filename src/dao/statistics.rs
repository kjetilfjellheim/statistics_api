...
impl StatisticsDao {
     ...
     */
    #[instrument(level = "debug", skip(self, connection_pool), fields(result), name = "dao:get_municipality_list")]
     ...
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:add_municipality")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:delete_municipality")]
     ...
     */
    #[instrument(level = "debug", skip(self, connection_pool), fields(result), name = "dao:get_statistics_list")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:add_statistics")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:delete_statistics")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:delete_value")]
     ...
     */
    #[instrument(level = "debug", skip(self, connection_pool), fields(result), name = "dao:get_values_list")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:add_value")]
     ...
     * A result indicating success or failure of the operation.
     */
    #[instrument(level = "debug", skip(self, transaction), fields(result), name = "dao:update_value")]
